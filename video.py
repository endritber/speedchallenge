...
def split_video_into_segments(video_path, labels_path, output_path):
...
if __name__ == '__main__':
  print(f'Started creating {DURATION} sec segments...')
  split_video_into_segments('data/train.mp4', 'data/train.txt', 'data/splits')